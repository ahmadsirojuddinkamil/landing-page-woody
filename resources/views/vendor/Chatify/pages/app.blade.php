        ...
        <div class="messenger-listView">
            ...
            <div class="m-header">
                ...
                <nav>
                    ...
                    <a href="/dashboard"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">DASHBOARD</span>
                    </a>
                ...
                <div class="messenger-listView-tabs">
                    <a href="#" @if ($type == 'user') class="active-tab" @endif data-view="users">
                        <span class="far fa-user"></span>Daftar Chat</a>
                </div>
...
@else
    ...
    @include('Chatify::pages.floating')
